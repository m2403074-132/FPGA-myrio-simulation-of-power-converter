...
El código desarrollado en LabVIEW FPGA se encuentra en el Zip en este se implementa los modelos matemáticos discretizados de los convertidores DC-DC Boost, Buck y Boost-Buck, obtenidos mediante la aplicación de las leyes de Kirchhoff y discretizados con el método de Euler.
